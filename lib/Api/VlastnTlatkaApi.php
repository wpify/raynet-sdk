...
/**
 * VlastnTlatkaApi Class Doc Comment
 *
 * @category Class
 * @package  RaynetApiClient
 * @author   OpenAPI Generator team
...
/**
    ...
    /**
     * Operation customButtonGet
     *
     * Načtení konfigurace
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['customButtonGet'] to see the possible values for this operation
     *
     * @throws \RaynetApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function customButtonGet(string $contentType = self::contentTypes['customButtonGet'][0])
    {
        $this->customButtonGetWithHttpInfo($contentType);
    }

    /**
     * Operation customButtonGetWithHttpInfo
     *
     * Načtení konfigurace
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['customButtonGet'] to see the possible values for this operation
     ...
     */
    public function customButtonGetWithHttpInfo(string $contentType = self::contentTypes['customButtonGet'][0])
    {
        $request = $this->customButtonGetRequest($contentType);
    ...
    /**
     * Operation customButtonGetAsync
     *
     * Načtení konfigurace
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['customButtonGet'] to see the possible values for this operation
     ...
     */
    public function customButtonGetAsync(string $contentType = self::contentTypes['customButtonGet'][0])
    {
        return $this->customButtonGetAsyncWithHttpInfo($contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation customButtonGetAsyncWithHttpInfo
     *
     * Načtení konfigurace
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['customButtonGet'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function customButtonGetAsyncWithHttpInfo(string $contentType = self::contentTypes['customButtonGet'][0])
    {
        $returnType = '';
        $request = $this->customButtonGetRequest($contentType);
    ...
    /**
     * Create request for operation 'customButtonGet'
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['customButtonGet'] to see the possible values for this operation
     *
     * @throws \InvalidArgumentException
     ...
     */
    public function customButtonGetRequest(string $contentType = self::contentTypes['customButtonGet'][0])
    {


        $resourcePath = '/customButton/';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation customButtonInsert
     *
     * Nové vlastní tlačítko
     *
     * @param  \RaynetApiClient\Model\CustomButtonInsertDto $custom_button_insert_dto custom_button_insert_dto (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['customButtonInsert'] to see the possible values for this operation
     *
     * @throws \RaynetApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \RaynetApiClient\Model\CustomButtonInsert201Response
     */
    public function customButtonInsert($custom_button_insert_dto = null, string $contentType = self::contentTypes['customButtonInsert'][0])
    {
        list($response) = $this->customButtonInsertWithHttpInfo($custom_button_insert_dto, $contentType);
        return $response;
    }

    /**
     * Operation customButtonInsertWithHttpInfo
     *
     * Nové vlastní tlačítko
     *
     * @param  \RaynetApiClient\Model\CustomButtonInsertDto $custom_button_insert_dto (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['customButtonInsert'] to see the possible values for this operation
     *
     * @throws \RaynetApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \RaynetApiClient\Model\CustomButtonInsert201Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function customButtonInsertWithHttpInfo($custom_button_insert_dto = null, string $contentType = self::contentTypes['customButtonInsert'][0])
    {
        $request = $this->customButtonInsertRequest($custom_button_insert_dto, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\RaynetApiClient\Model\CustomButtonInsert201Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\RaynetApiClient\Model\CustomButtonInsert201Response' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\RaynetApiClient\Model\CustomButtonInsert201Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\RaynetApiClient\Model\CustomButtonInsert201Response';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\RaynetApiClient\Model\CustomButtonInsert201Response',
    ...
    /**
     * Operation customButtonInsertAsync
     *
     * Nové vlastní tlačítko
     *
     * @param  \RaynetApiClient\Model\CustomButtonInsertDto $custom_button_insert_dto (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function customButtonInsertAsync($custom_button_insert_dto = null, string $contentType = self::contentTypes['customButtonInsert'][0])
    {
        return $this->customButtonInsertAsyncWithHttpInfo($custom_button_insert_dto, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation customButtonInsertAsyncWithHttpInfo
     *
     * Nové vlastní tlačítko
     *
     * @param  \RaynetApiClient\Model\CustomButtonInsertDto $custom_button_insert_dto (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function customButtonInsertAsyncWithHttpInfo($custom_button_insert_dto = null, string $contentType = self::contentTypes['customButtonInsert'][0])
    {
        $returnType = '\RaynetApiClient\Model\CustomButtonInsert201Response';
        $request = $this->customButtonInsertRequest($custom_button_insert_dto, $contentType);
    ...
    /**
     * Create request for operation 'customButtonInsert'
     *
     * @param  \RaynetApiClient\Model\CustomButtonInsertDto $custom_button_insert_dto (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['customButtonInsert'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function customButtonInsertRequest($custom_button_insert_dto = null, string $contentType = self::contentTypes['customButtonInsert'][0])
    {
        ...
        // for model (json/xml)
        if (isset($custom_button_insert_dto)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($custom_button_insert_dto));
            } else {
                $httpBody = $custom_button_insert_dto;
            }
    ...
    /**
     * Operation securityChecktokenDetailGet
     *
     * ověření bezpečnostního tokenu
     *
     * @param  string $token Token (required)
     * @param  int $person_id ID kontaktní osoby, které token patří (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['securityChecktokenDetailGet'] to see the possible values for this operation
     *
     * @throws \RaynetApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function securityChecktokenDetailGet($token, $person_id = null, string $contentType = self::contentTypes['securityChecktokenDetailGet'][0])
    {
        $this->securityChecktokenDetailGetWithHttpInfo($token, $person_id, $contentType);
    }

    /**
     * Operation securityChecktokenDetailGetWithHttpInfo
     *
     * ověření bezpečnostního tokenu
     *
     * @param  string $token Token (required)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function securityChecktokenDetailGetWithHttpInfo($token, $person_id = null, string $contentType = self::contentTypes['securityChecktokenDetailGet'][0])
    {
        $request = $this->securityChecktokenDetailGetRequest($token, $person_id, $contentType);
    ...
    /**
     * Operation securityChecktokenDetailGetAsync
     *
     * ověření bezpečnostního tokenu
     *
     * @param  string $token Token (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function securityChecktokenDetailGetAsync($token, $person_id = null, string $contentType = self::contentTypes['securityChecktokenDetailGet'][0])
    {
        return $this->securityChecktokenDetailGetAsyncWithHttpInfo($token, $person_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation securityChecktokenDetailGetAsyncWithHttpInfo
     *
     * ověření bezpečnostního tokenu
     *
     * @param  string $token Token (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function securityChecktokenDetailGetAsyncWithHttpInfo($token, $person_id = null, string $contentType = self::contentTypes['securityChecktokenDetailGet'][0])
    {
        $returnType = '';
        $request = $this->securityChecktokenDetailGetRequest($token, $person_id, $contentType);
    ...
    /**
     * Create request for operation 'securityChecktokenDetailGet'
     *
     * @param  string $token Token (required)
     * @param  int $person_id ID kontaktní osoby, které token patří (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['securityChecktokenDetailGet'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function securityChecktokenDetailGetRequest($token, $person_id = null, string $contentType = self::contentTypes['securityChecktokenDetailGet'][0])
    {

        // verify the required parameter 'token' is set
        if ($token === null || (is_array($token) && count($token) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $token when calling securityChecktokenDetailGet'
            );
        }



        $resourcePath = '/security/checktoken/{token}/{personId}/';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
