...
/**
 * NotifikaceApi Class Doc Comment
 *
 * @category Class
 * @package  RaynetApiClient
 * @author   OpenAPI Generator team
...
/**
     ...
     * smazání notifikace
     *
     * @param  int $notification_id ID notifikace (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['notificationDelete'] to see the possible values for this operation
     *
     * @throws \RaynetApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function notificationDelete($notification_id, string $contentType = self::contentTypes['notificationDelete'][0])
    {
        $this->notificationDeleteWithHttpInfo($notification_id, $contentType);
    }
     ...
     */
    public function notificationDeleteWithHttpInfo($notification_id, string $contentType = self::contentTypes['notificationDelete'][0])
    {
        $request = $this->notificationDeleteRequest($notification_id, $contentType);
     ...
     */
    public function notificationDeleteAsync($notification_id, string $contentType = self::contentTypes['notificationDelete'][0])
    {
        return $this->notificationDeleteAsyncWithHttpInfo($notification_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function notificationDeleteAsyncWithHttpInfo($notification_id, string $contentType = self::contentTypes['notificationDelete'][0])
    {
        $returnType = '';
        $request = $this->notificationDeleteRequest($notification_id, $contentType);
     ...
     */
    public function notificationDeleteRequest($notification_id, string $contentType = self::contentTypes['notificationDelete'][0])
    {

        // verify the required parameter 'notification_id' is set
        if ($notification_id === null || (is_array($notification_id) && count($notification_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $notification_id when calling notificationDelete'
            );
        }
     ...
     * @param  int $id Filtrování podle ID. Lze využít operátoru &#x60;EQ&#x60;, &#x60;NE&#x60;, &#x60;GT&#x60;, &#x60;GE&#x60;, &#x60;LT&#x60;, &#x60;LE&#x60; (optional)
     * @param  string $date Filtrování podle data notifikace. Lze využít operátoru &#x60;EQ&#x60;, &#x60;NE&#x60;, &#x60;GT&#x60;, &#x60;GE&#x60;, &#x60;LT&#x60;, &#x60;LE&#x60; (optional)
     * @param  int $sender Filtrování podle odesílatele. S operátorem &#x60;CUSTOM&#x60; (optional)
     * @param  string $recipient Filtrování podle příjemce. V případě &#x60;recipient[CUSTOM]&#x3D;all-recipient&#x60; operátoru umožní vyfiltrovat notifikace všech uživatelů. Tento filtr může použít pouze uživatel s rolí administrátor. Lze využít operátoru &#x60;EQ&#x60;, &#x60;NE&#x60;, &#x60;IN&#x60;, &#x60;CUSTOM&#x60; (optional)
     * @param  bool $flag Filtrování notifikací označených hvězdičkou. Lze využít operátoru &#x60;EQ&#x60;, &#x60;NE&#x60;. (optional)
     * @param  bool $read Filtrování přečtených notifikací. Lze využít operátoru &#x60;EQ&#x60;, &#x60;NE&#x60;. (optional)
     * @param  string $context Filtrování podle kontextu notifikace, kde kontext musí být ve formátu NázevEntity#IdEntity (podporované názvy entit jsou: &#39;company&#39;, &#39;lead&#39;, &#39;person&#39;, &#39;businessCase&#39;, &#39;offer&#39;, &#39;salesOrder&#39;, &#39;product&#39;, &#39;project&#39;, &#39;invoice&#39;, &#39;task&#39;, &#39;email&#39;, &#39;event&#39;, &#39;letter&#39;, &#39;phoneCall&#39;, &#39;meeting&#39;) (optional)
     ...
     * @return void
     */
    public function notificationGet($offset = null, $limit = null, $sort_column = null, $sort_direction = null, $id = null, $date = null, $sender = null, $recipient = null, $flag = null, $read = null, $context = null, string $contentType = self::contentTypes['notificationGet'][0])
    {
        $this->notificationGetWithHttpInfo($offset, $limit, $sort_column, $sort_direction, $id, $date, $sender, $recipient, $flag, $read, $context, $contentType);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function notificationGetWithHttpInfo($offset = null, $limit = null, $sort_column = null, $sort_direction = null, $id = null, $date = null, $sender = null, $recipient = null, $flag = null, $read = null, $context = null, string $contentType = self::contentTypes['notificationGet'][0])
    {
        $request = $this->notificationGetRequest($offset, $limit, $sort_column, $sort_direction, $id, $date, $sender, $recipient, $flag, $read, $context, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function notificationGetAsync($offset = null, $limit = null, $sort_column = null, $sort_direction = null, $id = null, $date = null, $sender = null, $recipient = null, $flag = null, $read = null, $context = null, string $contentType = self::contentTypes['notificationGet'][0])
    {
        return $this->notificationGetAsyncWithHttpInfo($offset, $limit, $sort_column, $sort_direction, $id, $date, $sender, $recipient, $flag, $read, $context, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function notificationGetAsyncWithHttpInfo($offset = null, $limit = null, $sort_column = null, $sort_direction = null, $id = null, $date = null, $sender = null, $recipient = null, $flag = null, $read = null, $context = null, string $contentType = self::contentTypes['notificationGet'][0])
    {
        $returnType = '';
        $request = $this->notificationGetRequest($offset, $limit, $sort_column, $sort_direction, $id, $date, $sender, $recipient, $flag, $read, $context, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function notificationGetRequest($offset = null, $limit = null, $sort_column = null, $sort_direction = null, $id = null, $date = null, $sender = null, $recipient = null, $flag = null, $read = null, $context = null, string $contentType = self::contentTypes['notificationGet'][0])
    {
