...
/**
 * TaxRateInsertDto Class Doc Comment
 *
 * @category Class
 * @package  RaynetApiClient
 * @author   OpenAPI Generator team
 ...
 */
class TaxRateInsertDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TaxRateInsertDto';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('num_value01', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets code01
     *
     * @param string $code01 [Hodnota sazby v procentech]
     *
     * @return self
     */
     ...
     * @return int|null
     */
    public function getNumValue01()
    {
        return $this->container['num_value01'];
    }

    /**
     * Sets num_value01
     *
     * @param int|null $num_value01 [Hodnota sazby v číselném vyjádření] - pokud není hodnota zadána, je vypočítána z code01
     *
     * @return self
     */
    public function setNumValue01($num_value01)
    {
        if (is_null($num_value01)) {
            throw new \InvalidArgumentException('non-nullable num_value01 cannot be null');
        }
        $this->container['num_value01'] = $num_value01;
