...
/**
 * CustomFieldEnumGet200Response Class Doc Comment
 *
 * @category Class
 * @package  RaynetApiClient
 * @author   OpenAPI Generator team
 ...
 */
class CustomFieldEnumGet200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CustomFieldEnumGet200Response';
    ...
    */
     ...
     * Sets data
     *
     * @param string[]|null $data Seznam všech dostupných položek číselníku, pokud se jedná o typ ENUMERATION
     *
     * @return self
     */
