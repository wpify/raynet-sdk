 ...
 */
class LeadEditDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LeadEditDto';
    ...
    */
     ...
     * Sets topic
     *
     * @param string|null $topic [Předmět]
     *
     * @return self
     */
