...
/**
 * DmsDocumentInsertDtoLink Class Doc Comment
 *
 * @category Class
 * @package  RaynetApiClient
 * @author   OpenAPI Generator team
 ...
 */
class DmsDocumentInsertDtoLink implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DmsDocumentInsertDto_link';
    ...
    */
     ...
     * Sets link
     *
     * @param string|null $link [Název odkazu] - pokud je vyplněno, je povinný i linkName
     *
     * @return self
     */
     ...
     * Sets link_name
     *
     * @param string|null $link_name [Název odkazu] - pokud je vyplněno, je povinný i link
     *
     * @return self
     */
