...
/**
 * MassEmailInsertDto Class Doc Comment
 *
 * @category Class
 * @package  RaynetApiClient
 * @author   OpenAPI Generator team
 ...
 */
class MassEmailInsertDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MassEmailInsertDto';
    ...
    */
     ...
     * Sets title
     *
     * @param string $title [Název] Název hromadného emailu
     *
     * @return self
     */
     ...
     * Sets source
     *
     * @param string $source [Zdroj] Mailingová služba
     *
     * @return self
     */
