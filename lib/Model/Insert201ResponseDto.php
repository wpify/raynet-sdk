...
/**
 * Insert201ResponseDto Class Doc Comment
 *
 * @category Class
 * @package  RaynetApiClient
 * @author   OpenAPI Generator team
 ...
 */
class Insert201ResponseDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Insert201ResponseDto';
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id ID nově založeného záznamu
     *
     * @return self
     */
