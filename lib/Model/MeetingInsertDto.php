...
/**
 * MeetingInsertDto Class Doc Comment
 *
 * @category Class
 * @package  RaynetApiClient
 * @author   OpenAPI Generator team
 ...
 */
class MeetingInsertDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MeetingInsertDto';
    ...
    */
     ...
     * Sets owner
     *
     * @param int $owner [Vlastník] ID kontaktní osoby, který je vlastníkem záznamu
     *
     * @return self
     */
     ...
     * Sets person
     *
     * @param int|null $person [Kontaktní osoba] ID kontaktní osoby, která je účastníkem schůzky
     *
     * @return self
     */
