...
/**
 * CompanyInsertDtoSocialNetworkContact Class Doc Comment
 *
 * @category Class
 * @package  RaynetApiClient
 * @author   OpenAPI Generator team
 ...
 */
class CompanyInsertDtoSocialNetworkContact implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CompanyInsertDto_socialNetworkContact';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('googleplus', $data ?? [], null);
    ...
    */
     ...
     * Sets googleplus
     *
     * @param string|null $googleplus [Google+]
     *
     * @return self
     */
    public function setGoogleplus($googleplus)
    {
        if (is_null($googleplus)) {
            throw new \InvalidArgumentException('non-nullable googleplus cannot be null');
        }
