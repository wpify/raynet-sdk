...
/**
 * OfferInsertDto Class Doc Comment
 *
 * @category Class
 * @package  RaynetApiClient
 * @author   OpenAPI Generator team
 ...
 */
class OfferInsertDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OfferInsertDto';
    ...
    */
     ...
     * Sets company
     *
     * @param int $company [Klient] ID klienta, pro kterého je nabídka vytvářena
     *
     * @return self
     */
     ...
     * Sets business_case
     *
     * @param int $business_case [OP] ID obch. případu nabídky
     *
     * @return self
     */
