...
/**
 * PersonInsertDtoRelationship Class Doc Comment
 *
 * @category Class
 * @package  RaynetApiClient
 * @author   OpenAPI Generator team
 ...
 */
class PersonInsertDtoRelationship implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PersonInsertDto_relationship';
    ...
    */
     ...
     * Sets company
     *
     * @param int|null $company [Klient] ID záznamu klienta
     *
     * @return self
     */
     ...
     *
     * @param int|null $company_address [Adresa] ID záznamu adresy z klienta CompanyAddress
     *
     * @return self
     */
