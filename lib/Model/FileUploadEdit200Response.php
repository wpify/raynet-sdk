...
/**
 * FileUploadEdit200Response Class Doc Comment
 *
 * @category Class
 * @package  RaynetApiClient
 * @author   OpenAPI Generator team
 ...
 */
class FileUploadEdit200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FileUploadEdit200Response';
    ...
    */
     ...
     * Sets uuid
     *
     * @param string|null $uuid [UUID nahraného souboru]
     *
     * @return self
     */
     ...
     * Sets file_name
     *
     * @param string|null $file_name [Název souboru]
     *
     * @return self
     */
     ...
     * Sets content_type
     *
     * @param string|null $content_type [Typ souboru]
     *
     * @return self
     */
     ...
     * Sets file_size
     *
     * @param int|null $file_size [Velikost souboru v bytech]
     *
     * @return self
     */
