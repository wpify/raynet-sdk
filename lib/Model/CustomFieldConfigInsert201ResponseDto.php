...
/**
 * CustomFieldConfigInsert201ResponseDto Class Doc Comment
 *
 * @category Class
 * @package  RaynetApiClient
 * @author   OpenAPI Generator team
 ...
 */
class CustomFieldConfigInsert201ResponseDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CustomFieldConfigInsert201ResponseDto';
    ...
    */
     ...
     * Sets field_name
     *
     * @param string|null $field_name fieldName nově založeného volitelného pole
     *
     * @return self
     */
