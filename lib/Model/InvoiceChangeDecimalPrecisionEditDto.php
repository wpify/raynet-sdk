...
/**
 * InvoiceChangeDecimalPrecisionEditDto Class Doc Comment
 *
 * @category Class
 * @package  RaynetApiClient
 * @author   OpenAPI Generator team
 ...
 */
class InvoiceChangeDecimalPrecisionEditDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InvoiceChangeDecimalPrecisionEditDto';
    ...
    */
     ...
     *
     * @param int $decimal_precision [Počet desetinných míst] Počet desetinných míst
     *
     * @return self
     */
