...
/**
 * Currency201Response Class Doc Comment
 *
 * @category Class
 * @package  RaynetApiClient
 * @author   OpenAPI Generator team
 ...
 */
class Currency201Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Currency201Response';
    ...
    */
     ...
     * Sets data
     *
     * @param int|null $data ID nově založené měny
     *
     * @return self
     */
