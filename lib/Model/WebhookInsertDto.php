...
/**
 * WebhookInsertDto Class Doc Comment
 *
 * @category Class
 * @package  RaynetApiClient
 * @author   OpenAPI Generator team
 ...
 */
class WebhookInsertDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WebhookInsertDto';
    ...
    public const EVENTS_CREATED = 'record.created';
    public const EVENTS_UPDATED = 'record.updated';
    public const EVENTS_DELETED = 'record.deleted';
    ...
    */
     ...
     * Sets url
     *
     * @param string $url [Url] Adresa pro zaslání webhooku (http nebo https).
     *
     * @return self
     */
     ...
     * Sets secret_token
     *
     * @param string|null $secret_token [Bezpečnostní token] Token bude zaslán spolu s požadavkem v HTTP hlavičce X-RAYNETCRM-Token.
     *
     * @return self
     */
     ...
     * Sets events
     *
     * @param string[] $events [Události] Typy událostí, které webhook bude zpracovávat (tzn. record.created, record.updated nebo record.deleted).
     *
     * @return self
     */
    public function setEvents($events)
    {
        ...
        if ((count($events) < 1)) {
            throw new \InvalidArgumentException('invalid length for $events when calling WebhookInsertDto., number of items must be greater than or equal to 1.');
        }
