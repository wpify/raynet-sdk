...
/**
 * WebhookTechnicalContactEditDto Class Doc Comment
 *
 * @category Class
 * @package  RaynetApiClient
 * @author   OpenAPI Generator team
 ...
 */
class WebhookTechnicalContactEditDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WebhookTechnicalContactEditDto';
    ...
    protected static $attributeMap = [
        'technical_contacts' => 'technicalContacts'
    ];
    ...
    protected static $setters = [
        'technical_contacts' => 'setTechnicalContacts'
    ];
    ...
    protected static $getters = [
        'technical_contacts' => 'getTechnicalContacts'
    ];
    ...
    {
        $this->setIfExists('technical_contacts', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['technical_contacts'] === null) {
            $invalidProperties[] = "'technical_contacts' can't be null";
        }
        if ((count($this->container['technical_contacts']) < 0)) {
            $invalidProperties[] = "invalid value for 'technical_contacts', number of items must be greater than or equal to 0.";
        }
    ...
    /**
     * Gets technical_contacts
     *
     * @return string[]
     */
    public function getTechnicalContacts()
    {
        return $this->container['technical_contacts'];
    }

    /**
     * Sets technical_contacts
     *
     * @param string[] $technical_contacts [Technický kontakt] Emaily na technický kontakt.
     *
     * @return self
     */
    public function setTechnicalContacts($technical_contacts)
    {
        if (is_null($technical_contacts)) {
            throw new \InvalidArgumentException('non-nullable technical_contacts cannot be null');
        }


        if ((count($technical_contacts) < 0)) {
            throw new \InvalidArgumentException('invalid length for $technical_contacts when calling WebhookTechnicalContactEditDto., number of items must be greater than or equal to 0.');
        }
        $this->container['technical_contacts'] = $technical_contacts;
