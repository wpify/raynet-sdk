...
/**
 * PriceListItemBulkUpsertEditDtoInner Class Doc Comment
 *
 * @category Class
 * @package  RaynetApiClient
 * @author   OpenAPI Generator team
 ...
 */
class PriceListItemBulkUpsertEditDtoInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PriceListItemBulkUpsertEditDto_inner';
    ...
    */
     ...
     * Sets product
     *
     * @param int|null $product [Produkt] ID produktu, který do ceníku přidávám
     *
     * @return self
     */
     ...
     * Sets price
     *
     * @param int|null $price [Prodejní cena]
     *
     * @return self
     */
