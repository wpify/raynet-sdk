...
/**
 * PriceListInsertDto Class Doc Comment
 *
 * @category Class
 * @package  RaynetApiClient
 * @author   OpenAPI Generator team
 ...
 */
class PriceListInsertDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PriceListInsertDto';
    ...
    */
     ...
     * Sets category
     *
     * @param int|null $category [Kategorie] ID záznamu z číselníku PriceListCategory
     *
     * @return self
     */
     ...
     * Sets valid_from
     *
     * @param \DateTime $valid_from [Otevřeno od] datum platnosti od
     *
     * @return self
     */
     ...
     * Sets valid_till
     *
     * @param \DateTime|null $valid_till [Otevřeno od] datum platnosti do
     *
     * @return self
     */
