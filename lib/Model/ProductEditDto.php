...
/**
 * ProductEditDto Class Doc Comment
 *
 * @category Class
 * @package  RaynetApiClient
 * @author   OpenAPI Generator team
 ...
 */
class ProductEditDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProductEditDto';
    ...
    */
     ...
     * Sets tax_rate
     *
     * @param float|null $tax_rate [Sazba DPH]
     *
     * @return self
     */
     ...
     * Sets category
     *
     * @param int|null $category [Kategorie] ID záznamu z číselníku ProductCategory
     *
     * @return self
     */
     ...
     * Sets product_line
     *
     * @param int|null $product_line [Produktová řada] ID záznamu z číselníku ProductLine
     *
     * @return self
     */
     ...
     * Sets price
     *
     * @param float|null $price [Standardní cena]
     *
     * @return self
     */
