...
/**
 * BusinessCaseClassification3EditDto Class Doc Comment
 *
 * @category Class
 * @package  RaynetApiClient
 * @author   OpenAPI Generator team
 ...
 */
class BusinessCaseClassification3EditDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BusinessCaseClassification3EditDto';
    ...
    */
     ...
     * Sets code01
     *
     * @param string|null $code01 [Název číselníkové položky]
     *
     * @return self
     */
