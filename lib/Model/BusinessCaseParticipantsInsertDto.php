...
/**
 * BusinessCaseParticipantsInsertDto Class Doc Comment
 *
 * @category Class
 * @package  RaynetApiClient
 * @author   OpenAPI Generator team
 ...
 */
class BusinessCaseParticipantsInsertDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BusinessCaseParticipantsInsertDto';
    ...
    */
     ...
     * Sets person
     *
     * @param int|null $person [Kontaktní osoba] ID záznamu kontaktní osoby
     *
     * @return self
     */
     ...
     * Sets category
     *
     * @param int|null $category [Kategorie participace] ID kategorie participace
     *
     * @return self
     */
