...
/**
 * InvoiceCreditNoteInsertDto Class Doc Comment
 *
 * @category Class
 * @package  RaynetApiClient
 * @author   OpenAPI Generator team
 ...
 */
class InvoiceCreditNoteInsertDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InvoiceCreditNoteInsertDto';
    ...
    */
     ...
     * Sets invoice_id
     *
     * @param int $invoice_id [Faktura] Faktura, která má být dopropisována.
     *
     * @return self
     */
     ...
     * Sets reason
     *
     * @param string $reason [Zdůvodnění opravu] Popis proč je dopropis vystavován.
     *
     * @return self
     */
