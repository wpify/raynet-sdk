...
/**
 * DmsDocumentEditDtoFile Class Doc Comment
 *
 * @category Class
 * @package  RaynetApiClient
 * @author   OpenAPI Generator team
 ...
 */
class DmsDocumentEditDtoFile implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DmsDocumentEditDto_file';
    ...
    */
     ...
     * Sets uuid
     *
     * @param string|null $uuid [UUID souboru]
     *
     * @return self
     */
