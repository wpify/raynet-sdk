...
/**
 * PriceListItemInsertDto Class Doc Comment
 *
 * @category Class
 * @package  RaynetApiClient
 * @author   OpenAPI Generator team
 ...
 */
class PriceListItemInsertDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PriceListItemInsertDto';
    ...
    */
     ...
     * Sets product
     *
     * @param int $product [Produkt] ID produktu, který do ceníku přidávám
     *
     * @return self
     */
