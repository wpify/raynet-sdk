...
/**
 * EmailInsertDto Class Doc Comment
 *
 * @category Class
 * @package  RaynetApiClient
 * @author   OpenAPI Generator team
 ...
 */
class EmailInsertDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EmailInsertDto';
    ...
    */
     ...
     * Sets person
     *
     * @param int|null $person [Kontaktní osoba] ID kontaktní osoby, která je v kentextu záznamu
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string|null $description [Obsah emailu]
     *
     * @return self
     */
