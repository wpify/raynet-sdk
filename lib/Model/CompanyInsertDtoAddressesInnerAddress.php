...
/**
 * CompanyInsertDtoAddressesInnerAddress Class Doc Comment
 *
 * @category Class
 * @package  RaynetApiClient
 * @author   OpenAPI Generator team
 ...
 */
class CompanyInsertDtoAddressesInnerAddress implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CompanyInsertDto_addresses_inner_address';
    ...
    */
     ...
     * Sets country
     *
     * @param string|null $country [Kód Země]
     *
     * @return self
     */
     ...
     * Sets lat
     *
     * @param float|null $lat [Zeměpisná šířka]
     *
     * @return self
     */
     ...
     * Sets lng
     *
     * @param float|null $lng [Zeměpisná délka]
     *
     * @return self
     */
