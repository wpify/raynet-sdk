...
/**
 * SalesOrderEditDto Class Doc Comment
 *
 * @category Class
 * @package  RaynetApiClient
 * @author   OpenAPI Generator team
 ...
 */
class SalesOrderEditDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SalesOrderEditDto';
    ...
    protected static $openAPITypes = [
        ...
        'request_delivery_date' => '\DateTime',
        'description' => 'string',
        'category' => 'int',
        'delivery_address' => '\RaynetApiClient\Model\SalesOrderEditDtoDeliveryAddress',
        'invoice_address' => '\RaynetApiClient\Model\SalesOrderEditDtoInvoiceAddress',
    ...
    protected static $setters = [
        ...
        'sales_order_status' => 'setSalesOrderStatus',
        'estimated_value' => 'setEstimatedValue',
        'valid_from' => 'setValidFrom',
        'valid_till' => 'setValidTill',
        'expiration_date' => 'setExpirationDate',
        'request_delivery_date' => 'setRequestDeliveryDate',
    ...
    protected static $getters = [
        ...
        'sales_order_status' => 'getSalesOrderStatus',
        'estimated_value' => 'getEstimatedValue',
        'valid_from' => 'getValidFrom',
        'valid_till' => 'getValidTill',
        'expiration_date' => 'getExpirationDate',
        'request_delivery_date' => 'getRequestDeliveryDate',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('sales_order_status', $data ?? [], null);
        ...
        $this->setIfExists('request_delivery_date', $data ?? [], null);
    ...
    */
     ...
     * Sets company
     *
     * @param int|null $company [Klient] ID klienta, pro kterého je objednávka vytvářena
     *
     * @return self
     */
     ...
     * Sets business_case
     *
     * @param int|null $business_case [OP] ID obch. případu objednávky
     *
     * @return self
     */
     ...
     * Sets offer
     *
     * @param int|null $offer [OP] ID nabídky, na kterou je objednávka napojena
     *
     * @return self
     */
     ...
     * Sets total_amount
     *
     * @param float|null $total_amount [Konečná cena] konečná cena objednávky
     *
     * @return self
     */
    ...
    /**
     * Gets sales_order_status
     *
     * @return int|null
     */
    public function getSalesOrderStatus()
    {
        return $this->container['sales_order_status'];
    }

    /**
     * Sets sales_order_status
     *
     * @param int|null $sales_order_status [Stav] ID stavu objednávky (z číselníku salesOrderStatus)
     *
     * @return self
     */
    public function setSalesOrderStatus($sales_order_status)
    {
        if (is_null($sales_order_status)) {
            throw new \InvalidArgumentException('non-nullable sales_order_status cannot be null');
        }
        $this->container['sales_order_status'] = $sales_order_status;
     ...
     * Sets valid_from
     *
     * @param \DateTime|null $valid_from [Otevřeno od] datum vytvoření objednávky
     *
     * @return self
     */
     ...
     * Sets valid_till
     *
     * @param \DateTime|null $valid_till [Otevřeno od] datum uzavření objednávky
     *
     * @return self
     */
     ...
     *
     * @param \DateTime|null $expiration_date [Konec platnosti] konec platnosti objednávky
     *
     * @return self
     */
    ...
    /**
     * Gets request_delivery_date
     *
     * @return \DateTime|null
     */
    public function getRequestDeliveryDate()
    {
        return $this->container['request_delivery_date'];
    }

    /**
     * Sets request_delivery_date
     *
     * @param \DateTime|null $request_delivery_date [Dodat do] datum dodání
     *
     * @return self
     */
    public function setRequestDeliveryDate($request_delivery_date)
    {
        if (is_null($request_delivery_date)) {
            throw new \InvalidArgumentException('non-nullable request_delivery_date cannot be null');
        }
        $this->container['request_delivery_date'] = $request_delivery_date;
     ...
     * Sets category
     *
     * @param int|null $category [Kategorie] ID záznamu z číselníku SalesOrderCategory
     *
     * @return self
     */
     ...
     *
     * @return \RaynetApiClient\Model\SalesOrderEditDtoDeliveryAddress|null
     */
     ...
     *
     * @param \RaynetApiClient\Model\SalesOrderEditDtoDeliveryAddress|null $delivery_address delivery_address
     *
     * @return self
     */
     ...
     *
     * @return \RaynetApiClient\Model\SalesOrderEditDtoInvoiceAddress|null
     */
     ...
     *
     * @param \RaynetApiClient\Model\SalesOrderEditDtoInvoiceAddress|null $invoice_address invoice_address
     *
     * @return self
     */
    ...
    public function setItems($items)
    {
        ...
        if ((count($items) < 1)) {
            throw new \InvalidArgumentException('invalid length for $items when calling SalesOrderEditDto., number of items must be greater than or equal to 1.');
        }
