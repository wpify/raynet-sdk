...
/**
 * PersonRelationshipInsertDto Class Doc Comment
 *
 * @category Class
 * @package  RaynetApiClient
 * @author   OpenAPI Generator team
 ...
 */
class PersonRelationshipInsertDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PersonRelationshipInsertDto';
    ...
    */
     ...
     * Sets company
     *
     * @param int $company [Klient] ID záznamu klienta
     *
     * @return self
     */
