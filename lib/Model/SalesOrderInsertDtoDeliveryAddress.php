...
/**
 * SalesOrderInsertDtoDeliveryAddress Class Doc Comment
 *
 * @category Class
 ...
 */
class SalesOrderInsertDtoDeliveryAddress implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SalesOrderInsertDto_deliveryAddress';
    ...
    protected static $openAPITypes = [
        ...
        'zip_code' => 'string',
        'country_code' => 'string',
        'invoice_address' => '\RaynetApiClient\Model\SalesOrderInsertDtoDeliveryAddressInvoiceAddress'
    ];
    ...
    */
     ...
     * Sets province
     *
     * @param string|null $province [Kraj]
     *
     * @return self
     */
     ...
     * Sets zip_code
     *
     * @param string|null $zip_code [PSČ]
     *
     * @return self
     */
     ...
     * Sets country_code
     *
     * @param string|null $country_code [Kód Země]
     *
     * @return self
     */
     ...
     *
     * @return \RaynetApiClient\Model\SalesOrderInsertDtoDeliveryAddressInvoiceAddress|null
     */
     ...
     *
     * @param \RaynetApiClient\Model\SalesOrderInsertDtoDeliveryAddressInvoiceAddress|null $invoice_address invoice_address
     *
     * @return self
     */
