...
/**
 * CurrencyEditDto Class Doc Comment
 *
 * @category Class
 * @package  RaynetApiClient
 * @author   OpenAPI Generator team
 ...
 */
class CurrencyEditDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CurrencyEditDto';
    ...
    */
     ...
     * Sets code01
     *
     * @param string|null $code01 [Název měny]
     *
     * @return self
     */
     ...
     * Sets code02
     *
     * @param string|null $code02 [Kód měny]
     *
     * @return self
     */
