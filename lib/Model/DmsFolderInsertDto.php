...
/**
 * DmsFolderInsertDto Class Doc Comment
 *
 * @category Class
 * @package  RaynetApiClient
 * @author   OpenAPI Generator team
 ...
 */
class DmsFolderInsertDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DmsFolderInsertDto';
    ...
    */
     ...
     * Sets parent
     *
     * @param int|null $parent [Nadřazená složka] ID složky, do které má být složka vložena. Pokud není vyplněna je založena do hlavní složky.
     *
     * @return self
     */
