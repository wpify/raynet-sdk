...
/**
 * EventInsertDto Class Doc Comment
 *
 * @category Class
 * @package  RaynetApiClient
 * @author   OpenAPI Generator team
 ...
 */
class EventInsertDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EventInsertDto';
    ...
    */
     ...
     * Sets person
     *
     * @param int|null $person [Kontaktní osoba] ID kontaktní osoby, která je účastníkem události
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string|null $description [Informace o události]
     *
     * @return self
     */
