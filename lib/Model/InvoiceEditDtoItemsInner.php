...
/**
 * InvoiceEditDtoItemsInner Class Doc Comment
 *
 * @category Class
 * @package  RaynetApiClient
 * @author   OpenAPI Generator team
 ...
 */
class InvoiceEditDtoItemsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InvoiceEditDto_items_inner';
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id [ID] id položky faktury (prázdné ID => položka bude založena, záporné ID => položka bude smazána, kladné ID => položka bude změněna)
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name [Položka] Název položky faktury. Je vyžadováno, pokud se vkládá nová položka (id není zadáno)
     *
     * @return self
     */
     ...
     * Sets unit_price
     *
     * @param float|null $unit_price [Cena]
     *
     * @return self
     */
     ...
     * Sets amount
     *
     * @param float|null $amount [Množství]
     *
     * @return self
     */
     ...
     * Sets unit_label
     *
     * @param string|null $unit_label [Jednotka]
     *
     * @return self
     */
