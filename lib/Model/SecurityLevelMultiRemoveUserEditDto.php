...
/**
 * SecurityLevelMultiRemoveUserEditDto Class Doc Comment
 *
 * @category Class
 * @package  RaynetApiClient
 * @author   OpenAPI Generator team
 ...
 */
class SecurityLevelMultiRemoveUserEditDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SecurityLevelMultiRemoveUserEditDto';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['person_ids'] === null) {
            $invalidProperties[] = "'person_ids' can't be null";
        }
     ...
     * Sets person_ids
     *
     * @param int[] $person_ids person_ids
     *
     * @return self
     */
    public function setPersonIds($person_ids)
    {
        if (is_null($person_ids)) {
            throw new \InvalidArgumentException('non-nullable person_ids cannot be null');
        }
