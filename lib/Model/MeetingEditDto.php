...
/**
 * MeetingEditDto Class Doc Comment
 *
 * @category Class
 * @package  RaynetApiClient
 * @author   OpenAPI Generator team
 ...
 */
class MeetingEditDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MeetingEditDto';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('meeting_place', $data ?? [], null);
    ...
    */
     ...
     * Sets description
     *
     * @param string|null $description [Otázky k projednání]
     *
     * @return self
     */
     ...
     * Sets solution
     *
     * @param string|null $solution [Výsledek jednání]
     *
     * @return self
     */
    ...
    {
        return $this->container['meeting_place'];
    }

    /**
     * Sets meeting_place
     *
     * @param string|null $meeting_place [Místo konání]
     *
     * @return self
     */
    public function setMeetingPlace($meeting_place)
    {
        if (is_null($meeting_place)) {
            throw new \InvalidArgumentException('non-nullable meeting_place cannot be null');
        }
        $this->container['meeting_place'] = $meeting_place;
