...
/**
 * LetterInsertDto Class Doc Comment
 *
 * @category Class
 * @package  RaynetApiClient
 * @author   OpenAPI Generator team
 ...
 */
class LetterInsertDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LetterInsertDto';
    ...
    */
     ...
     * Sets person
     *
     * @param int|null $person [Kontaktní osoba] ID kontaktní osoby, které se dopis zasílá
     *
     * @return self
     */
