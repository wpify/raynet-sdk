...
/**
 * BusinessCaseRelationshipCategoryEditDto Class Doc Comment
 *
 * @category Class
 * @package  RaynetApiClient
 * @author   OpenAPI Generator team
 ...
 */
class BusinessCaseRelationshipCategoryEditDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BusinessCaseRelationshipCategoryEditDto';
    ...
    */
     ...
     * Sets code01
     *
     * @param string|null $code01 [Název kategorie]
     *
     * @return self
     */
