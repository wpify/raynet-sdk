...
/**
 * LeadPhaseInsertDto Class Doc Comment
 *
 * @category Class
 * @package  RaynetApiClient
 * @author   OpenAPI Generator team
 ...
 */
class LeadPhaseInsertDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LeadPhaseInsertDto';
    ...
    */
     ...
     * Sets code01
     *
     * @param string $code01 [Název stavu]
     *
     * @return self
     */
     ...
     * Sets code02
     *
     * @param string|null $code02 [Barva stavu]
     *
     * @return self
     */
