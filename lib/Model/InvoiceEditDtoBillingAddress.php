...
/**
 * InvoiceEditDtoBillingAddress Class Doc Comment
 *
 * @category Class
 ...
 */
class InvoiceEditDtoBillingAddress implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InvoiceEditDto_billingAddress';
