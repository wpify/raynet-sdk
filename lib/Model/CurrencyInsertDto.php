...
/**
 * CurrencyInsertDto Class Doc Comment
 *
 * @category Class
 * @package  RaynetApiClient
 * @author   OpenAPI Generator team
 ...
 */
class CurrencyInsertDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CurrencyInsertDto';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('str_value01', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['code02'] === null) {
            $invalidProperties[] = "'code02' can't be null";
        }
     ...
     * Sets code01
     *
     * @param string $code01 [Název měny]
     *
     * @return self
     */
     ...
     * @return string|null
     */
    public function getStrValue01()
    {
        return $this->container['str_value01'];
    }

    /**
     * Sets str_value01
     *
     * @param string|null $str_value01 [Popis měny]
     *
     * @return self
     */
    public function setStrValue01($str_value01)
    {
        if (is_null($str_value01)) {
            throw new \InvalidArgumentException('non-nullable str_value01 cannot be null');
        }
        $this->container['str_value01'] = $str_value01;
