...
/**
 * DmsDocumentInsertDto Class Doc Comment
 *
 * @category Class
 * @package  RaynetApiClient
 * @author   OpenAPI Generator team
 ...
 */
class DmsDocumentInsertDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DmsDocumentInsertDto';
    ...
    protected static $openAPITypes = [
        'file' => '\RaynetApiClient\Model\DmsDocumentInsertDtoFile',
        'link' => '\RaynetApiClient\Model\DmsDocumentInsertDtoLink',
        'status' => 'string',
        'security_level' => 'int',
        'category' => 'int',
        'template' => 'bool',
    ...
    public const STATUS_A_DRAFT = 'A_DRAFT';
    public const STATUS_E_WIN = 'E_WIN';
    public const STATUS_G_STORNO = 'G_STORNO';
    ...
    */
     ...
     * Gets file
     *
     * @return \RaynetApiClient\Model\DmsDocumentInsertDtoFile|null
     */
     ...
     * Sets file
     *
     * @param \RaynetApiClient\Model\DmsDocumentInsertDtoFile|null $file file
     *
     * @return self
     */
     ...
     * Gets link
     *
     * @return \RaynetApiClient\Model\DmsDocumentInsertDtoLink|null
     */
     ...
     * Sets link
     *
     * @param \RaynetApiClient\Model\DmsDocumentInsertDtoLink|null $link link
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string|null $status [Stav] - výchozí hodnota A_DRAFT
     *
     * @return self
     */
     ...
     * Sets category
     *
     * @param int|null $category [Kategorie] ID záznamu z číselníku DocumentCategory
     *
     * @return self
     */
     ...
     * Sets template
     *
     * @param bool|null $template [Šablona]
     *
     * @return self
     */
     ...
     * Sets valid_from
     *
     * @param \DateTime|null $valid_from [Platné od] datum platné od
     *
     * @return self
     */
     ...
     * Sets valid_till
     *
     * @param \DateTime|null $valid_till [Platné do] datum platné do
     *
     * @return self
     */
     ...
     * Sets folder
     *
     * @param int $folder [Umístění] ID záznamu adresáře
     *
     * @return self
     */
