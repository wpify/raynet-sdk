...
/**
 * CompanyInsertDtoAddressesInner Class Doc Comment
 *
 * @category Class
 * @package  RaynetApiClient
 * @author   OpenAPI Generator team
 ...
 */
class CompanyInsertDtoAddressesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CompanyInsertDto_addresses_inner';
    ...
    protected static $openAPITypes = [
        'address' => '\RaynetApiClient\Model\CompanyInsertDtoAddressesInnerAddress',
    ...
    */
     ...
     * Gets address
     *
     * @return \RaynetApiClient\Model\CompanyInsertDtoAddressesInnerAddress|null
     */
     ...
     * Sets address
     *
     * @param \RaynetApiClient\Model\CompanyInsertDtoAddressesInnerAddress|null $address address
     *
     * @return self
     */
     ...
     * Sets territory
     *
     * @param int|null $territory [Obchodní teritorium] ID záznamu z číselníku Territory
     *
     * @return self
     */
