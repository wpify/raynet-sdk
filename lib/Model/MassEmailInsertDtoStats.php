...
/**
 * MassEmailInsertDtoStats Class Doc Comment
 *
 * @category Class
 * @package  RaynetApiClient
 * @author   OpenAPI Generator team
 ...
 */
class MassEmailInsertDtoStats implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MassEmailInsertDto_stats';
    ...
    */
     ...
     * Sets sent
     *
     * @param int|null $sent [Odesláno] Počet obeslanýh adresátů
     *
     * @return self
     */
     ...
     * Sets clicked
     *
     * @param int|null $clicked [Kliknuto] Počet prokliků
     *
     * @return self
     */
     ...
     * Sets opened
     *
     * @param int|null $opened [Otevřeno] Počet otevřených emailů
     *
     * @return self
     */
     ...
     * Sets unsubscribed
     *
     * @param int|null $unsubscribed [Odhlášeno] Počet odhlášených adresátů
     *
     * @return self
     */
