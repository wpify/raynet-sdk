...
/**
 * BusinessCaseRelationshipCategoryInsertDto Class Doc Comment
 *
 * @category Class
 * @package  RaynetApiClient
 * @author   OpenAPI Generator team
 ...
 */
class BusinessCaseRelationshipCategoryInsertDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BusinessCaseRelationshipCategoryInsertDto';
    ...
    */
     ...
     * Sets code01
     *
     * @param string $code01 [Název kategorie]
     *
     * @return self
     */
     ...
     * Sets code02
     *
     * @param string|null $code02 [Barva kategorie]
     *
     * @return self
     */
