...
/**
 * CompanyRelationshipInsertDto Class Doc Comment
 *
 * @category Class
 * @package  RaynetApiClient
 * @author   OpenAPI Generator team
 ...
 */
class CompanyRelationshipInsertDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CompanyRelationshipInsertDto';
    ...
    protected static $attributeMap = [
        ...
        'company_join_type' => 'companyJoinType',
        'notice' => 'notice'
    ];
    ...
    protected static $setters = [
        'company_join' => 'setCompanyJoin',
        'company_join_type' => 'setCompanyJoinType',
        'notice' => 'setNotice'
    ];
    ...
    protected static $getters = [
        'company_join' => 'getCompanyJoin',
        'company_join_type' => 'getCompanyJoinType',
        'notice' => 'getNotice'
    ];
    ...
    public const COMPANY_JOIN_TYPE_PARENT = 'parent';
    public const COMPANY_JOIN_TYPE_SLAVE = 'slave';
    public const COMPANY_JOIN_TYPE_FREE = 'free';
     ...
     * @return string[]
     */
    public function getCompanyJoinTypeAllowableValues()
    {
        return [
            self::COMPANY_JOIN_TYPE_PARENT,
            self::COMPANY_JOIN_TYPE_SLAVE,
            self::COMPANY_JOIN_TYPE_FREE,
        ];
    }
    ...
    {
        $this->setIfExists('company_join', $data ?? [], null);
        $this->setIfExists('company_join_type', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['company_join'] === null) {
            $invalidProperties[] = "'company_join' can't be null";
        }
        if ($this->container['company_join_type'] === null) {
            $invalidProperties[] = "'company_join_type' can't be null";
        }
        $allowedValues = $this->getCompanyJoinTypeAllowableValues();
        if (!is_null($this->container['company_join_type']) && !in_array($this->container['company_join_type'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'company_join_type', must be one of '%s'",
                $this->container['company_join_type'],
    ...
    {
        return $this->container['company_join'];
    }

    /**
     * Sets company_join
     *
     * @param int $company_join [Klient] ID záznamu klienta, ke kterému bude vazba vytvořena
     *
     * @return self
     */
    public function setCompanyJoin($company_join)
    {
        if (is_null($company_join)) {
            throw new \InvalidArgumentException('non-nullable company_join cannot be null');
        }
        $this->container['company_join'] = $company_join;

        return $this;
    }

    /**
     * Gets company_join_type
     *
     * @return string
     */
    public function getCompanyJoinType()
    {
        return $this->container['company_join_type'];
    }

    /**
     * Sets company_join_type
     *
     * @param string $company_join_type [Typ vztahu] Typ vztahu (parent - vztah mateřského klienta na dceřinného klienta, slave - vztah dceřinné na mateřskou, free - volná vazba)
     *
     * @return self
     */
    public function setCompanyJoinType($company_join_type)
    {
        if (is_null($company_join_type)) {
            throw new \InvalidArgumentException('non-nullable company_join_type cannot be null');
        }
        $allowedValues = $this->getCompanyJoinTypeAllowableValues();
        if (!in_array($company_join_type, $allowedValues, true)) {
        ...
        $this->container['company_join_type'] = $company_join_type;
     ...
     * Sets notice
     *
     * @param string|null $notice [Poznámka]
     *
     * @return self
     */
