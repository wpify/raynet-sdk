...
/**
 * GdprFormAgreementInsertDto Class Doc Comment
 *
 * @category Class
 * @package  RaynetApiClient
 * @author   OpenAPI Generator team
 ...
 */
class GdprFormAgreementInsertDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GdprFormAgreementInsertDto';
    ...
    */
     ...
     * Sets code01
     *
     * @param string $code01 [Popis formy souhlasu]
     *
     * @return self
     */
