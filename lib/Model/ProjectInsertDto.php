...
/**
 * ProjectInsertDto Class Doc Comment
 *
 * @category Class
 * @package  RaynetApiClient
 * @author   OpenAPI Generator team
 ...
 */
class ProjectInsertDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProjectInsertDto';
    ...
    */
     ...
     * Sets company
     *
     * @param int $company [Klient] ID klienta, pro kterého je projekt vytvářen
     *
     * @return self
     */
     ...
     * Sets total_amount
     *
     * @param int|null $total_amount [Konečná cena] konečná cena projektu
     *
     * @return self
     */
     ...
     * Sets project_status
     *
     * @param int|null $project_status [Stav] ID záznamu z ProjectStatus. Pokud nebude vyplněno, založí se projekt do prvního stavu.
     *
     * @return self
     */
