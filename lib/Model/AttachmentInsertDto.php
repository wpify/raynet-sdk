...
/**
 * AttachmentInsertDto Class Doc Comment
 *
 * @category Class
 * @package  RaynetApiClient
 * @author   OpenAPI Generator team
 ...
 */
class AttachmentInsertDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AttachmentInsertDto';
    ...
    */
     ...
     * Sets link
     *
     * @param string|null $link [URL odkazu] pro přidání odkazu
     *
     * @return self
     */
     ...
     * Sets link_name
     *
     * @param string|null $link_name [Název odkazu] pro přidání odkazu
     *
     * @return self
     */
    public function setLinkName($link_name)
    {
        if (is_null($link_name)) {
            throw new \InvalidArgumentException('non-nullable link_name cannot be null');
        }
     ...
     * Sets uuid
     *
     * @param string|null $uuid [UUID souboru] pro přidání přílohy
     *
     * @return self
     */
     ...
     * Sets file_name
     *
     * @param string|null $file_name [Název souboru] pro přidání přílohy
     *
     * @return self
     */
     ...
     * Sets content_type
     *
     * @param string|null $content_type [Typ souboru] pro přidání přílohy
     *
     * @return self
     */
     ...
     * Sets file_size
     *
     * @param int|null $file_size [Velikost souboru v bytech] pro přidání přílohy
     *
     * @return self
     */
     ...
     * Sets folder_id
     *
     * @param int|null $folder_id [DMS složka] ID složky v knihovně dokumentů
     *
     * @return self
     */
