...
/**
 * PostInsertDto Class Doc Comment
 *
 * @category Class
 * @package  RaynetApiClient
 * @author   OpenAPI Generator team
 ...
 */
class PostInsertDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostInsertDto';
    ...
    */
     ...
     * Sets parent
     *
     * @param int|null $parent [ID nadřazeného příspěvku, pod který má být nový komentář zařazen]
     *
     * @return self
     */
