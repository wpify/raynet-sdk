...
/**
 * MassEmailRecipientBulkUpdateEditDtoInner Class Doc Comment
 *
 * @category Class
 * @package  RaynetApiClient
 * @author   OpenAPI Generator team
 ...
 */
class MassEmailRecipientBulkUpdateEditDtoInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MassEmailRecipientBulkUpdateEditDto_inner';
    ...
    */
     ...
     * Sets email
     *
     * @param string $email Email, podle kterého se bude dohledávat kontakt v CRM
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string $status [Stav] Stav odeslání
     *
     * @return self
     */
