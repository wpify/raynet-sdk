...
/**
 * SalesOrderEditDtoDeliveryAddress Class Doc Comment
 *
 * @category Class
 ...
 */
class SalesOrderEditDtoDeliveryAddress implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SalesOrderEditDto_deliveryAddress';
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name [Název] Klienta / Dodací adresy
     *
     * @return self
     */
