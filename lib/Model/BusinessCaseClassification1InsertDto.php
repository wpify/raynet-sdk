...
/**
 * BusinessCaseClassification1InsertDto Class Doc Comment
 *
 * @category Class
 * @package  RaynetApiClient
 * @author   OpenAPI Generator team
 ...
 */
class BusinessCaseClassification1InsertDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BusinessCaseClassification1InsertDto';
    ...
    */
     ...
     * Sets code01
     *
     * @param string $code01 [Název číselníkové položky]
     *
     * @return self
     */
