...
/**
 * AttachmentInsertCustomFieldDto Class Doc Comment
 *
 * @category Class
 * @package  RaynetApiClient
 * @author   OpenAPI Generator team
 ...
 */
class AttachmentInsertCustomFieldDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AttachmentInsertCustomFieldDto';
    ...
    */
     ...
     * Sets uuid
     *
     * @param string $uuid [UUID souboru]
     *
     * @return self
     */
     ...
     * Sets file_name
     *
     * @param string $file_name [Název souboru]
     *
     * @return self
     */
     ...
     * Sets content_type
     *
     * @param string $content_type [Typ souboru]
     *
     * @return self
     */
     ...
     * Sets file_size
     *
     * @param int $file_size [Velikost souboru v bytech]
     *
     * @return self
     */
