...
/**
 * WebhookInsert201ResponseDto Class Doc Comment
 *
 * @category Class
 * @package  RaynetApiClient
 * @author   OpenAPI Generator team
 ...
 */
class WebhookInsert201ResponseDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WebhookInsert201ResponseDto';
    ...
    */
     ...
     * Sets uuid
     *
     * @param string|null $uuid UUID nově založeného webhooku.
     *
     * @return self
     */
