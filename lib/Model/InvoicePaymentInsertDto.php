...
/**
 * InvoicePaymentInsertDto Class Doc Comment
 *
 * @category Class
 * @package  RaynetApiClient
 * @author   OpenAPI Generator team
 ...
 */
class InvoicePaymentInsertDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InvoicePaymentInsertDto';
    ...
    */
     ...
     * Sets amount
     *
     * @param float $amount [Uhrazená suma] Uhrazená částka
     *
     * @return self
     */
     ...
     * Sets date
     *
     * @param \DateTime $date [Datum úhrady] Datum úhrady
     *
     * @return self
     */
