...
/**
 * BusinessCaseCreateWithItemsInsertDto Class Doc Comment
 *
 * @category Class
 * @package  RaynetApiClient
 * @author   OpenAPI Generator team
 ...
 */
class BusinessCaseCreateWithItemsInsertDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BusinessCaseCreateWithItemsInsertDto';
    ...
    protected static $openAPITypes = [
        ...
        'tags' => 'string[]',
        'custom_fields' => '\RaynetApiClient\Model\BusinessCaseInsertDtoCustomFields',
        'items' => '\RaynetApiClient\Model\BusinessCaseCreateWithItemsInsertDtoItemsInner[]'
    ];
    ...
    */
     ...
     * Sets company
     *
     * @param int $company [Klient] ID klienta, pro kterého je obchodní případ vytvářen
     *
     * @return self
     */
     ...
     *
     * @param int|null $business_case_phase [Stav] ID záznamu z BusinessCasePhase. Pokud nebude vyplněno, založí se OP do prvního stavu.
     *
     * @return self
     */
     ...
     * Gets custom_fields
     *
     * @return \RaynetApiClient\Model\BusinessCaseInsertDtoCustomFields|null
     */
     ...
     * Sets custom_fields
     *
     * @param \RaynetApiClient\Model\BusinessCaseInsertDtoCustomFields|null $custom_fields custom_fields
     *
     * @return self
     */
     ...
     * Gets items
     *
     * @return \RaynetApiClient\Model\BusinessCaseCreateWithItemsInsertDtoItemsInner[]|null
     */
     ...
     * Sets items
     *
     * @param \RaynetApiClient\Model\BusinessCaseCreateWithItemsInsertDtoItemsInner[]|null $items items
     *
     * @return self
     */
    public function setItems($items)
    {
        ...
        if ((count($items) < 1)) {
            throw new \InvalidArgumentException('invalid length for $items when calling BusinessCaseCreateWithItemsInsertDto., number of items must be greater than or equal to 1.');
        }
