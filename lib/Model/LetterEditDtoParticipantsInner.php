...
/**
 * LetterEditDtoParticipantsInner Class Doc Comment
 *
 * @category Class
 * @package  RaynetApiClient
 * @author   OpenAPI Generator team
 ...
 */
class LetterEditDtoParticipantsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LetterEditDto_participants_inner';
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id [ID] id participanta aktivity (prázdné ID => participant bude založen nový, záporné ID => participant bude smazán, kladné ID => participant bude změněn)
     *
     * @return self
     */
     ...
     * Sets owner
     *
     * @param bool|null $owner [Vlastník] příznak, že je participant zároveň vlastníkem aktivity
     *
     * @return self
     */
     ...
     * Sets role
     *
     * @param string|null $role [Směr aktivity]
     *
     * @return self
     */
     ...
     * Sets person
     *
     * @param int|null $person [Kontaktní osoba] ID kontaktní osoby, pokud je participant kontaktní osoba
     *
     * @return self
     */
     ...
     * Sets company
     *
     * @param int|null $company [Klient] ID klienta, pokud je participant klient
     *
     * @return self
     */
     ...
     * Sets lead
     *
     * @param int|null $lead [Lead] ID leadu, pokud je participant lead
     *
     * @return self
     */
    ...
    {
        if (is_null($lead)) {
            array_push($this->openAPINullablesSetToNull, 'lead');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('lead', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
