...
/**
 * BusinessCaseInsertDtoCustomFields Class Doc Comment
 *
 * @category Class
 * @package  RaynetApiClient
 * @author   OpenAPI Generator team
 ...
 */
class BusinessCaseInsertDtoCustomFields implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BusinessCaseInsertDto_customFields';
    ...
    protected static $setters = [
        'custom_field_key' => 'setCustomFieldKey'
    ];
    ...
    protected static $getters = [
        'custom_field_key' => 'getCustomFieldKey'
    ];
    ...
    {
        $this->setIfExists('custom_field_key', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets custom_field_key
     *
     * @return string|null
     */
    public function getCustomFieldKey()
    {
        return $this->container['custom_field_key'];
    }

    /**
     * Sets custom_field_key
     *
     * @param string|null $custom_field_key type  - number - pro volitelné pole typu BIG_DECIMAL,  - boolean - pro volitelné pole typu BOOLEAN,  - date - pro typ DATE  - string - pro ostatní customFieldKey = vygenerovaný unikátní klíč volitelného pole (získaný z konfigurace volitelných polí). Pokud je hodnota neprázdná, nastaví se volitelnému poli, pokud je prázdná nebo null, hodnota se ve volitelném poli vymaže.
     *
     * @return self
     */
    public function setCustomFieldKey($custom_field_key)
    {
        if (is_null($custom_field_key)) {
            throw new \InvalidArgumentException('non-nullable custom_field_key cannot be null');
        }
        $this->container['custom_field_key'] = $custom_field_key;
