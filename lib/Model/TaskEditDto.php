 ...
 */
class TaskEditDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TaskEditDto';
    ...
    */
     ...
     * Sets deadline
     *
     * @param \DateTime|null $deadline [Deadline] deadline datum
     *
     * @return self
     */
