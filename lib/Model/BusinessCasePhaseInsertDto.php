...
/**
 * BusinessCasePhaseInsertDto Class Doc Comment
 *
 * @category Class
 * @package  RaynetApiClient
 * @author   OpenAPI Generator team
 ...
 */
class BusinessCasePhaseInsertDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BusinessCasePhaseInsertDto';
    ...
    protected static $attributeMap = [
        ...
        'business_case_type_id' => 'businessCaseTypeId'
    ];
    ...
    protected static $setters = [
        ...
        'business_case_type_id' => 'setBusinessCaseTypeId'
    ];
    ...
    protected static $getters = [
        ...
        'business_case_type_id' => 'getBusinessCaseTypeId'
    ];
    ...
    {
        $this->setIfExists('code01', $data ?? [], null);
        $this->setIfExists('code02', $data ?? [], null);
        $this->setIfExists('probability', $data ?? [], null);
        $this->setIfExists('business_case_type_id', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['code01'] === null) {
            $invalidProperties[] = "'code01' can't be null";
        }
    ...
    {
        return $this->container['code01'];
    }

    /**
     * Sets code01
     *
     * @param string $code01 [Název stavu OP]
     *
     * @return self
     */
    ...
    {
        if (is_null($code01)) {
            throw new \InvalidArgumentException('non-nullable code01 cannot be null');
        }
        $this->container['code01'] = $code01;
    ...
    {
        return $this->container['code02'];
    }

    /**
     * Sets code02
     *
     * @param string|null $code02 [Barva stavu OP]
     *
     * @return self
     */
    ...
    {
        if (is_null($code02)) {
            throw new \InvalidArgumentException('non-nullable code02 cannot be null');
        }
        $this->container['code02'] = $code02;
     ...
     * Sets probability
     *
     * @param int|null $probability [Výchozí pravděpodobnost] pro daný stav OP
     *
     * @return self
     */
    ...
    /**
     * Gets business_case_type_id
     *
     * @return int|null
     */
    public function getBusinessCaseTypeId()
    {
        return $this->container['business_case_type_id'];
    }

    /**
     * Sets business_case_type_id
     *
     * @param int|null $business_case_type_id [ID typu OP] (povinné, pokud je zapnuto rozšíření 'Typy obchodu' v nastavení evidence OP)
     *
     * @return self
     */
    public function setBusinessCaseTypeId($business_case_type_id)
    {
        if (is_null($business_case_type_id)) {
            array_push($this->openAPINullablesSetToNull, 'business_case_type_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('business_case_type_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['business_case_type_id'] = $business_case_type_id;
