...
/**
 * CompanyClassification2Insert201ResponseDto Class Doc Comment
 *
 * @category Class
 * @package  RaynetApiClient
 * @author   OpenAPI Generator team
 ...
 */
class CompanyClassification2Insert201ResponseDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CompanyClassification2Insert201ResponseDto';
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id ID nově založené položky číselníku
     *
     * @return self
     */
