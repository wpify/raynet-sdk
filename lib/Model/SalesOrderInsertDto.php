...
/**
 * SalesOrderInsertDto Class Doc Comment
 *
 * @category Class
 * @package  RaynetApiClient
 * @author   OpenAPI Generator team
 ...
 */
class SalesOrderInsertDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SalesOrderInsertDto';
    ...
    protected static $openAPITypes = [
        ...
        'delivery_address' => '\RaynetApiClient\Model\SalesOrderInsertDtoDeliveryAddress'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['business_case'] === null) {
            $invalidProperties[] = "'business_case' can't be null";
        }
     ...
     * Sets company
     *
     * @param int $company [Klient] ID klienta, pro kterého je objednávka vytvářena
     *
     * @return self
     */
     ...
     * Sets business_case
     *
     * @param int $business_case [OP] ID obch. případu objednávky
     *
     * @return self
     */
     ...
     *
     * @param int|null $sales_order_status [Stav] ID záznamu z SalesOrderStatus. Pokud nebude vyplněno, založí se objednávka do prvního stavu.
     *
     * @return self
     */
     ...
     *
     * @return \RaynetApiClient\Model\SalesOrderInsertDtoDeliveryAddress|null
     */
     ...
     *
     * @param \RaynetApiClient\Model\SalesOrderInsertDtoDeliveryAddress|null $delivery_address delivery_address
     *
     * @return self
     */
