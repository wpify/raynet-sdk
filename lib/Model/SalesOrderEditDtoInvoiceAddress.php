...
/**
 * SalesOrderEditDtoInvoiceAddress Class Doc Comment
 *
 * @category Class
 ...
 */
class SalesOrderEditDtoInvoiceAddress implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SalesOrderEditDto_invoiceAddress';
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name [Název] Klienta / Fakturační adresy
     *
     * @return self
     */
