...
/**
 * CustomFieldConfigGet200ResponseItemDtoInner Class Doc Comment
 *
 * @category Class
 * @package  RaynetApiClient
 * @author   OpenAPI Generator team
 ...
 */
class CustomFieldConfigGet200ResponseItemDtoInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CustomFieldConfigGet200ResponseItemDto_inner';
    ...
    */
     ...
     * Sets label
     *
     * @param string|null $label [Název pole] Uživatelské pojmenování volitelného pole.
     *
     * @return self
     */
     ...
     * Sets data_type
     *
     * @param string|null $data_type [Typ pole] - `STRING` Textové pole, - `FILE` Soubor, - `TEXT` Velké textové pole, - `ENUMERATION` Roletka, - `HYPERLINK` Odkaz, - `DATE` Datum, - `DATETIME` Datum s časem, - `TIME` Časové pole, - `BIG_DECIMAL` Číslo, - `MONETARY` Měna, - `PERCENT` Procenta, - `BOOLEAN` Zatržítko
     *
     * @return self
     */
     ...
     * Sets enumeration
     *
     * @param string[]|null $enumeration Seznam všech dostupných položek číselníku, pokud se jedná o typ ENUMERATION
     *
     * @return self
     */
     ...
     * Sets group_name
     *
     * @param string|null $group_name [Název panelu] Název skupiny volitelných polí, který se zobrazuje v titulku panelu s polemi.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name Vygenerovaný jednoznačný název (klíč) volitelného pole.
     *
     * @return self
     */
     ...
     * Sets currency
     *
     * @param string|null $currency [Měna]
     *
     * @return self
     */
