...
/**
 * BusinessCaseCreateWithItemsInsertDtoItemsInner Class Doc Comment
 *
 * @category Class
 * @package  RaynetApiClient
 * @author   OpenAPI Generator team
 ...
 */
class BusinessCaseCreateWithItemsInsertDtoItemsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BusinessCaseCreateWithItemsInsertDto_items_inner';
    ...
    */
     ...
     * Sets name
     *
     * @param string $name [Název] Povinná hodnota pro nekategorizovaný produkt nebo v případě, že se produkt bude zakládat nový (kód není dohledán v exisujících produktech).
     *
     * @return self
     */
