...
/**
 * ExtIdInsertDto Class Doc Comment
 *
 * @category Class
 * @package  RaynetApiClient
 * @author   OpenAPI Generator team
 ...
 */
class ExtIdInsertDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ExtIdInsertDto';
    ...
    */
     ...
     * Sets ext_id
     *
     * @param string $ext_id Externí identifikátor
     *
     * @return self
     */
