...
/**
 * AttachmentInsert201Response Class Doc Comment
 *
 * @category Class
 * @package  RaynetApiClient
 * @author   OpenAPI Generator team
 ...
 */
class AttachmentInsert201Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'attachmentInsert201Response';
    ...
    */
     ...
     * Sets data
     *
     * @param int|null $data ID nově založené přílohy
     *
     * @return self
     */
